  ...
  const calculateResult = async () => {
    try {
      ...
      questions.forEach((question, index) => {
        console.log(question.correctOption, selectedOptions[index]);
      ...
      let questionMarks = examData.totalMarks / examData.questions?.length;
      const Obtainedmarks = questionMarks * correctAnswers.length;
      let verdict = "Pass";
          ...
          <div className="flex justify-center mt-2 gap-2">
            <div className="flex flex-col gap-2 result">
              ...
              <div className="marks">
                ...
                <h1 className="text-md">
                  Obtained Marks : {(result.correctAnswers.length) * (examData.totalMarks/examData.questions.length)}
                </h1>
                <h1 className="text-md">
